...
export function Navbar() {
  ...
  return (
    <div
      className={`${isMobile ? "fixed top-0 left-0 right-0 z-50 bg-[#FFF1EB]/95 backdrop-blur-sm " : "fixed top-1 left-0 right-0 z-50"}`}
    >
      <motion.div
      ...
      >
        <div
          className={`flex items-center justify-between h-10 whitespace-nowrap ${isMobile ? "px-2 pointer-events-auto" : "pointer-events-auto"}`}
        >
          <NavItem
            item={navItems[0]}
